    ...
    public partial class InitialSetUp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Edgebands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HandleModel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MechanismType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MechanismQuantity = table.Column<int>(type: "int", nullable: false),
                    HingeType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HingeQuantity = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufacturerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TextureCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EdgebandId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Furnitures_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Edgebands_IsDeleted",
                table: "Edgebands",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Furnitures_EdgebandId",
                table: "Furnitures",
                column: "EdgebandId");

            migrationBuilder.CreateIndex(
                name: "IX_Furnitures_HardwareId",
                table: "Furnitures",
                column: "HardwareId");

            migrationBuilder.CreateIndex(
                name: "IX_Furnitures_IsDeleted",
                table: "Furnitures",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Furnitures_ProjectId",
                table: "Furnitures",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Furnitures_TextureId",
                table: "Furnitures",
                column: "TextureId");

            migrationBuilder.CreateIndex(
                name: "IX_Hardwares_IsDeleted",
                table: "Hardwares",
                column: "IsDeleted");
